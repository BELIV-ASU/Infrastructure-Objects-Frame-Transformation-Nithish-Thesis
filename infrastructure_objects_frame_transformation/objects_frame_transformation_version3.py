...
class FrameListener(Node):
    ...
    def __init__(self):
        ...
        self.infrastructure_objects_subscriber = self.create_subscription(DetectedObjects, \
                '/perception/object_recognition/detection/carom/objects', self.infrastructure_objects_transformer, 10)
    ...
    def frame_transformation(self):
        try:
            t = self.tf_buffer.lookup_transform('base_link', 'camera_infrastructure_local_frame', self.time_stamp)
            ...
            #print("TF between base_link and camera frame (x, y): ", self.x_tf, self.y_tf)
    ...
    def infrastructure_objects_transformer(self, infrastructure_detection_msg): 
        ...
        infrastructure_detection_msg_cache = infrastructure_detection_msg
        self.time_stamp = infrastructure_detection_msg.header.stamp
        
        for j, infrastructure_object in enumerate(infrastructure_detection_msg_cache.objects):
        ...
        #print("Time taken for message format conversion (during subscribtion): ", time_difference)
        ...
        infrastructure_detection_msg_cache.header.frame_id = "base_link"

        self.transformed_objects_publisher.publish(infrastructure_detection_msg_cache)
